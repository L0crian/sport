...
<head>
    ...
    <link rel="stylesheet" href="{{asset('libs/linea/styles.css')}}" />
    ...
    <link rel="stylesheet" href="{{asset('css/skins/purple.css')}}" />
    ...
    <div class="top_wrapper">
        @if (Route::has('login'))
            <div class="top-right links">
                @if (Auth::check())
                    <a href="{{ url('/forum') }}">Перейти к сайту</a>
                @else
        ...
        <div class="top_descr">
            <div class="top_centered">
                <div class="top_text">
                    <h1>Sport Education</h1>
                    <p>Сайт - который научит вас понимать свой организм!</p>
                </div>
                <div class="links social_links">
...
<section id="about" class="s_about bg_light">
    ...
    <div class="section_content">
        <div class="container">
            <div class="row">
                <div class="col-md-2 col-md-push-2 animation_1">
                    <!--	<h3>Фото</h3>
                        <div class="person">
                            <a href="img/photo.jpg" class="popup"><img src="img/photo.jpg" alt="Alt" /></a>
                        </div>-->
                </div>
                <div class="col-md-5 col-md-pull-2 animation_2">
                    <h3>Немного о нас</h3>
                ...
                <div class="col-md-5 animation_3 personal_last_block">
                    <h3>Для чего наш ресурс?</h3>
                    <ul>
                        <li>-Вы будете знать основы анатомии</li>
                        <li>-Понимать факторы роста мышц</li>
                        <li>-Развивать локальную выносливость</li>
                        <li>-Развивать силу</a></li>
                        <li>-Как добиться жиросжигания</a></li>
                        <li>-Грамотно планировать тренировочный график</a></li>
                    </ul>
...
<section id="resume" class="s_resume bg_dark">
    <div class="section_header">
                ...
                <div class="resume_container">
                    <div class="col-md-6 col-sm-6 left">
                        ...
                        <div class="resume_item">
                            <div class="year">Дневник тренировок</div>
                        ...
                        <div class="resume_item">
                            <div class="year">Обучающий контент</div>
                            <!--<div class="resume_description">ООО "Пронькина забава"<strong>Программист</strong></div>-->
                            <p>Lorem Ipsum - это текст-"рыба", часто используемый в печати и вэб-дизайне. Lorem Ipsum является стандартной "рыбой" для текстов на латинице с начала XVI века. В то время некий безымянный печатник создал большую коллекцию размеров и форм шрифтов, используя Lorem Ipsum.</p>
                        </div>
                        <div class="resume_item">
                            <div class="year">Раздел, где вы можете задавать вопросы</div>
                            <!--<div class="resume_description">ООО "Пронькина забава"<strong>Программист</strong></div>-->
                            <p>Lorem Ipsum - это текст-"рыба", часто используемый в печати и вэб-дизайне. Lorem Ipsum является стандартной "рыбой" для текстов на латинице с начала XVI века. В то время некий безымянный печатник создал большую коллекцию размеров и форм шрифтов, используя Lorem Ipsum.</p>
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-6 right">
                        ...
                        <div class="resume_item">
                            <div class="year">Онлайн тест для получения стартовой программы</div>
                            <!--<div class="resume_description"><strong>Программист</strong>ООО "Пронькина забава"</div>-->
                            <p>Lorem Ipsum - это текст-"рыба", часто используемый в печати и вэб-дизайне. Lorem Ipsum является стандартной "рыбой" для текстов на латинице с начала XVI века. В то время некий безымянный печатник создал большую коллекцию размеров и форм шрифтов, используя Lorem Ipsum.</p>
                        </div>
                        <div class="resume_item">
                            <div class="year">Личная статистика</div>
                            <!--<div class="resume_description"><strong>Программист</strong>ООО "Пронькина забава"</div>-->
                            <p>Lorem Ipsum - это текст-"рыба", часто используемый в печати и вэб-дизайне. Lorem Ipsum является стандартной "рыбой" для текстов на латинице с начала XVI века. В то время некий безымянный печатник создал большую коллекцию размеров и форм шрифтов, используя Lorem Ipsum.</p>
                        </div>
                        <div class="resume_item">
                            <div class="year">Онлайн чат</div>
                            <!--<div class="resume_description"><strong>Программист</strong>ООО "Пронькина забава"</div>-->
                            <p>Lorem Ipsum - это текст-"рыба", часто используемый в печати и вэб-дизайне. Lorem Ipsum является стандартной "рыбой" для текстов на латинице с начала XVI века. В то время некий безымянный печатник создал большую коллекцию размеров и форм шрифтов, используя Lorem Ipsum.</p>
                        </div>
                    </div>
...
<section id="contacts" class="s_contacts bg_light">
    <div class="section_header">
        <h2>Контакты</h2>
        <div class="s_descr_wrap">
            <div class="s_descr">Оставьте ваше пожелание</div>
        </div>
    </div>
    <div class="section_content">
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-sm-6">
                    <div class="contact_box">
                        ...
                        <h3>Адрес:</h3>
                        <p>Одесса: ул.Греческая 1</p>
                    </div>
                    <div class="contact_box">
                        <div class="contacts_icon icon-basic-smartphone"></div>
                        <h3>Телефон:</h3>
                        <p>+380-073-441-74-91</p>
                    </div>
                    <div class="contact_box">
                        <div class="contacts_icon icon-basic-webpage-img-txt"></div>
                        <h3>Веб-сайт:</h3>
                        <p><a href="//webdesign-master.ru" target="_blank">sport-education.com</a></p>
                    </div>
                </div>
                <div class="col-md-6 col-sm-6">
...
<script src="{{asset('libs/jquery/jquery-2.1.3.min.js')}}"></script>
...
<script src="{{asset('libs/jqBootstrapValidation/jqBootstrapValidation.js')}}"></script>
